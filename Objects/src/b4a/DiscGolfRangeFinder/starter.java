...
public class starter extends android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new anywheresoftware.b4a.ShellBA(this, null, null, "b4a.DiscGolfRangeFinder", "b4a.DiscGolfRangeFinder.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.DiscGolfRangeFinder.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
